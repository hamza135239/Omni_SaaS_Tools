...
export const metadata: Metadata = {
  title: "Remove Background From Image Free (1-Click AI) â€” Fast | ToolboxSaaS",
  description:
  ...
  openGraph: {
    title: "Remove Background From Image Free (1-Click AI) â€” Fast",
    description:
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-16">
      ...
      <ToolPageHero
        ...
        description="Remove background from photos automatically with AI precision. Download HD transparent PNG in one click."
