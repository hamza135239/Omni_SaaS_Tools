...
export default function ToolsPortalPage() {
  ...
  const tools = [
    ...
    },
    {
      ...
      desc: "Resumly-grade ATS scanner. Audit your resume score out of 100, keyword gaps, section order & quick fixes.",
      category: "career",
      badge: "Resumly Grade",
    ...
    },
    {
      ...
      desc: "Build clean, ATS-optimized professional resumes with live PDF export & printable templates.",
      category: "career",
      badge: "ATS Optimized",
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
            {[
              ...
              { id: "pdf", label: "PDF Tools (4)" },
              { id: "career", label: "Career & Resume AI" },
            ].map((cat) => (
              <button
                key={cat.id}
