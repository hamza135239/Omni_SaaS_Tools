...
export default function HomePage() {
  ...
  const websiteSchema = {
    ...
    "@type": "WebSite",
    "name": "ToolboxSaaS",
    "url": "https://toolboxsaas.com",
    "description": "100% Free online web utility suite for PDFs, ATS resume checking, and AI image tools.",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://toolboxsaas.com/tools?q={search_term_string}",
  ...
  const organizationSchema = {
    ...
    "name": "ToolboxSaaS",
    "url": "https://toolboxsaas.com",
    "logo": "https://toolboxsaas.com/logo.png",
    "sameAs": [],
  };
  ...
  const allTools = [
    ...
    },
    {
      ...
      desc: "Audit your resume score out of 100, keyword gaps, section order & quick fixes with actionable insights.",
    ...
    },
    {
      ...
      desc: "Build clean, ATS-optimized professional resumes with live PDF export & 6 printable templates.",
      badge: "6 ATS Templates",
    ...
    },
    {
      ...
      desc: "Generate persuasive, job-tailored cover letters in seconds with custom tone settings.",
      badge: "AI Writer",
    ...
    },
    {
      ...
      desc: "Compress JPG, PNG, and WEBP image file sizes up to 90% with live quality slider & byte savings stats.",
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950 font-sans pb-16">
      ...
      {/* Inject WebSite and Organization JSON-LD Schemas */}
      <script
