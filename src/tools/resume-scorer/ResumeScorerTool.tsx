  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6 md:p-8 bg-white rounded-2xl border border-zinc-200 shadow-xs transition-all duration-200">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-6 mb-6 border-b border-zinc-100">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-violet-50 text-violet-800 border border-violet-200 mb-2">
            <Cpu className="w-3.5 h-3.5 text-violet-600" /> Free Career AI Tool
          </div>
        ...
        {result && (
          ...
          >
            <RefreshCw className="w-4 h-4 text-zinc-600" /> Upload New Resume
          </button>
        )}
      </div>
        ...
        <div className="space-y-6">
          {!pdfFile ? (
            <div
              ...
              className="relative border-2 border-dashed border-zinc-200 hover:border-indigo-500 rounded-2xl p-10 md:p-16 text-center cursor-pointer bg-zinc-50/50 hover:bg-indigo-50/30 transition-all group overflow-hidden"
            >
              <input
                type="file"
                ref={fileInputRef}
              ...
              <h3 className="text-lg font-bold text-zinc-950 mb-1">
                Drag & Drop your resume PDF here, or <span className="text-indigo-600 underline">Upload File</span>
              </h3>

              <p className="text-xs text-zinc-500 max-w-md mx-auto">
                PDF documents up to 25MB. Processed 100% locally in your browser.
              </p>
            </div>
          ) : (
