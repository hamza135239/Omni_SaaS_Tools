      ...
      {!file ? (
        ...
        >
          ...
          <h3 style={{ color: "#0f172a" }} className="text-xl md:text-2xl font-black mb-1 font-outfit">
            Drag & Drop image file here, or <span style={{ color: "#4f46e5" }} className="underline font-black">Choose File</span>
          </h3>

          <p style={{ color: "#475569" }} className="text-xs max-w-md mx-auto font-bold mb-6">
            Supports PNG, JPG, WEBP formats. Live slider compression.
          </p>
